package com.example.sunshop.Fragment;
...
import com.example.sunshop.Activity.NavigatorActivity;
import com.example.sunshop.Common;
import com.example.sunshop.MainActivity;
import com.example.sunshop.Model.Users;
import com.example.sunshop.R;
...
public class LoginTabFragment extends Fragment {
    ...
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://sunshop-ab617-default-rtdb.firebaseio.com/");
    @Override
                        ...
                        if (snapshot.hasChild(edt_phone.getText().toString())){
                            ...
                            if (user.getPass().equals(edt_pass.getText().toString())){
                                if (user.getRole() == 0) {
                                    ...
                                    startActivity(new Intent(getActivity(), NavigatorActivity.class));
